...
const CrearAdmin = () => {
  ...
  const handleSubmit = (e) => {
    ...
    .then((response) => {
        ...
        toast.success("Registro exitoso, recuerda validar tu correo", {
  ...
  return (
    <>
      <Toaster />
      <div className="p-7 flex-1 h-screen overflow-y-scroll scrollbar-hide bg-silver bg-lightPurple">
